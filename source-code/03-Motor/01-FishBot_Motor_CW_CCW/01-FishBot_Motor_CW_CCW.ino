 ...
 * 
 * GPIO Mapping:
 * Motor 2 (Kiri):  GPIO 12 (Forward/CW), 13 (Backward/CCW)
 * Motor 1 (Kanan): GPIO 22 (Forward/CW), 23 (Backward/CCW)
 */

// Motor Pins
#define MOTOR1_A 22  // Motor 2 (Kanan) CW/Forward
#define MOTOR1_B 23  // Motor 2 (Kanan) CCW/Backward

#define MOTOR2_A 12  // Motor 1 (Kiri) CW/Forward
#define MOTOR2_B 13  // Motor 1 (Kiri) CCW/Backward
